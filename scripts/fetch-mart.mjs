...
const REGIONS = [
  ...
  { code: '3211', name: '춘천', prefix: ['강원'] },
  { code: '3214', name: '강릉', prefix: ['강원도 강릉', '강원 강릉', '강원특별자치도 강릉'] },
  { code: '3311', name: '청주', prefix: ['충북', '충청북도'] },
  { code: '3411', name: '천안', prefix: ['충남', '충청남도'] },
  { code: '3511', name: '전주', prefix: ['전북', '전라북도'] },
  { code: '3613', name: '순천', prefix: ['전라남도', '전남 '] },
  { code: '3711', name: '포항', prefix: ['경북', '경상북도'] },
  { code: '3714', name: '안동', prefix: ['경북 안동', '경상북도 안동'] },
  { code: '3814', name: '창원', prefix: ['경남', '경상남도'] },
