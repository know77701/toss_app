...
/** 마트 물가 탭에서 앞에 보여줄 생필품 키워드 (상품명 부분 일치, 순서대로) */
export const MART_POPULAR = [
  '신라면', '진라면', '삼양라면', '너구리', '짜파게티', '햇반', '흰우유', '우유', '계란', '달걀', '생수', '삼다수', '아이시스',
  '화장지', '키친타올', '물티슈', '세제', '섬유유연제', '샴푸', '치약', '칫솔', '바디워시', '비누', '참치', '스팸', '식용유',
  '설탕', '소금', '간장', '고추장', '된장', '마요네즈', '케찹', '커피', '맥심', '카누', '콜라', '사이다', '오렌지주스', '두유',
  '요구르트', '치즈', '버터', '두부', '김치', '만두', '라면', '과자', '새우깡', '초코파이', '아이스크림', '기저귀', '생리대',
  '맥주', '소주', '참이슬', '카스', '테라',
];
